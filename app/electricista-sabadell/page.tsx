...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://electricistasbarcelona.com/electricista-sabadell/',
  }
};
...
export default function ElectricistaSabadellPage() {
  const serviceSchema = generateServiceSchema({
    ...
    url: 'https://electricistasbarcelona.com/electricista-sabadell/',
      ...
      <section className="relative bg-slate-900 text-white overflow-hidden pt-6 pb-12 sm:pt-8 sm:pb-16 border-b border-slate-800">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-4">
          <Breadcrumbs
            ...
            currentPageUrl="https://electricistasbarcelona.com/electricista-sabadell/"
          />
