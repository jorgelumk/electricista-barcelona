...
export function generateMetadata({ params }: PageProps) {
  ...
  return {
    ...
    alternates: {
      canonical: `https://electricistasbarcelona.com/blog/${post.slug}/`,
    },
    openGraph: {
      title: post.metaTitle,
      description: post.description,
      url: `https://electricistasbarcelona.com/blog/${post.slug}/`,
    ...
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-10 text-slate-800 leading-relaxed">
        <Breadcrumbs
          ...
          currentPageUrl={`https://electricistasbarcelona.com/blog/${post.slug}/`}
        />
