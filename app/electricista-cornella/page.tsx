...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://electricistasbarcelona.com/electricista-cornella/',
  }
};

export default function ElectricistaCornellaPage() {
  const serviceSchema = generateServiceSchema({
    ...
    url: 'https://electricistasbarcelona.com/electricista-cornella/',
    areaServed: ['Cornellà de Llobregat', 'Centre', 'Almeda', 'Riera', 'Sant Ildefons', 'La Gavarra', 'El Pedró']
  });

  const faqs = [
    {
      question: '¿Cuánto tardáis en atender una urgencia eléctrica en Cornellà?',
      answer: 'Disponemos de instaladores asignados al Baix Llobregat. El tiempo medio de respuesta en cualquier barrio de Cornellà (Centre, Almeda, Sant Ildefons, La Gavarra) es inferior a 45 a 60 minutos.'
    },
    {
      question: '¿Emitís el Boletín Eléctrico (CIE) oficial en Cornellà?',
      answer: 'Sí. Nuestros instaladores REIC oficiales revisan la instalación e integran telemáticamente el boletín imprescindible para dar de alta la luz o ampliar potencia con Endesa.'
    },
    {
      question: '¿Atendéis urgencias nocturnas y festivos en Cornellà?',
      answer: 'Sí, disponemos de guardia técnica permanente las 24 horas del día, los 365 días del año para atajar apagones, cortocircuitos o saltos de diferencial.'
    }
  ];
      ...
      <section className="relative bg-slate-900 text-white overflow-hidden pt-6 pb-12 sm:pt-8 sm:pb-16 border-b border-slate-800">
        <div className="absolute inset-0 z-0 opacity-20 pointer-events-none">
          <Image
            ...
            alt="Electricista autorizado en Cornellà de Llobregat"
            fill
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-4">
          <Breadcrumbs
            ...
            currentPageUrl="https://electricistasbarcelona.com/electricista-cornella/"
          />
          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="inline-flex items-center gap-2 bg-amber-500/10 border border-amber-500/30 text-amber-400 text-xs font-extrabold px-3 py-1 rounded-full uppercase tracking-wider">
              ...
              <span>Electricistas Autorizados REIC · Cornellà</span>
            </div>

            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black text-white tracking-tight leading-tight text-balance">
              Electricista en Cornellà: <span className="text-amber-400">urgencias 24 horas</span> e instalaciones
            </h1>

            <p className="text-slate-300 text-base sm:text-lg leading-relaxed">
              ¿Avería o sin luz en Cornellà? Red de instaladores autorizados con llegada en menos de <strong className="text-amber-400">60 minutos</strong> en Centre, Almeda, Riera, Sant Ildefons, La Gavarra y El Pedró. Presupuesto cerrado previo y garantía por escrito.
            </p>
            ...
            <div className="bg-amber-500 text-slate-950 p-5 rounded-2xl shadow-2xl space-y-3 border-2 border-amber-400">
              <div className="flex items-center justify-between font-extrabold text-sm uppercase tracking-wide border-b border-slate-950/20 pb-2">
                <span className="flex items-center gap-2">
                  ...
                  Atención Inmediata 24h Cornellà
                </span>
              ...
              <div className="flex flex-col sm:flex-row items-center gap-3">
                ...
                <a
                  href="https://wa.me/34657144186?text=Hola,%20necesito%20un%20electricista%20urgente%20en%20Cornella"
                  target="_blank"
          ...
          <div className="lg:col-span-5">
            <ContactForm
              ...
              paginaOrigen="Landing Cornellà - Hero"
              title="Electricista en Cornellà"
              subtitle="Pide tu presupuesto técnico para urgencias, boletines o reformas en Cornellà."
            />
          </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className="my-16 space-y-8">
          <div className="bg-slate-900 text-white rounded-3xl p-6 sm:p-10 border border-slate-800 shadow-xl grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-7 space-y-5">
              <span className="text-amber-400 font-extrabold text-xs uppercase tracking-widest block">Servicio Urgente Cornellà</span>
              <h2 className="text-2xl sm:text-3xl font-black tracking-tight text-white">
                Electricista urgente 24 horas en Cornellà de Llobregat
              </h2>
              <p className="text-slate-300 text-sm leading-relaxed">
                Asistencia inmediata para apagones, saltos de diferencial o averías de cuadro en Centre, Almeda, Sant Ildefons o La Gavarra. Desplazamiento garantizado en menos de 60 minutos.
              </p>

              <div className="space-y-3">
                <div className="p-3.5 bg-slate-800/80 rounded-xl border border-slate-700/50">
                  <h3 className="font-bold text-amber-400 text-base mb-1">Reparación segura e in situ</h3>
                  <p className="text-xs text-slate-300">
                    Unidades móviles equipadas con componentes homologados REBT para atajar derivaciones a tierra en la primera visita.
                  </p>
                </div>

                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div className="p-3 bg-slate-800/50 rounded-lg text-xs border border-slate-700/40">
                    <h4 className="font-bold text-white mb-1">Pérdida de luz en vivienda</h4>
                    <p className="text-slate-400">Verificación de IGA, diferencial principal y cuadro.</p>
                  </div>
                  <div className="p-3 bg-slate-800/50 rounded-lg text-xs border border-slate-700/40">
                    <h4 className="font-bold text-white mb-1">El diferencial salta</h4>
                    <p className="text-slate-400">Detección de fugas en circuitos de electrodomésticos.</p>
                  </div>
                  <div className="p-3 bg-slate-800/50 rounded-lg text-xs border border-slate-700/40">
                    <h4 className="font-bold text-white mb-1">Olor a chispas o plástico</h4>
                    <p className="text-slate-400">Desconexión y sustitución del magnetotérmico afectado.</p>
                  </div>
                  <div className="p-3 bg-slate-800/50 rounded-lg text-xs border border-slate-700/40">
                    <h4 className="font-bold text-white mb-1">Enchufes inoperativos</h4>
                    <p className="text-slate-400">Saneamiento de bornes sueltos o quemados.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-2 flex flex-col sm:flex-row items-center gap-4">
                ...
                >
                  ...
                  Llamar Urgencias Cornellà: 657 144 186
                </a>
              </div>
            </div>
            ...
            <div className="lg:col-span-5 relative h-72 sm:h-96 rounded-2xl overflow-hidden shadow-2xl border border-slate-700">
              <Image
                ...
                alt="Electricista urgente en Cornellà"
                fill
        ...
        <section className="bg-amber-500/10 border border-amber-500/30 rounded-2xl p-6 sm:p-8 my-12 text-slate-900">
          <h2 className="text-xl sm:text-2xl font-black text-slate-900 mb-4 flex items-center gap-2">
            ...
            Qué hacer mientras llega el electricista a tu inmueble en Cornellà
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
            <div className="bg-white p-4 rounded-xl shadow-sm border border-slate-200 space-y-1">
              ...
              <p className="text-slate-600 text-xs">Si aprecias olor a plástico quemado, corta inmediatamente el IGA principal del cuadro.</p>
            </div>
            <div className="bg-white p-4 rounded-xl shadow-sm border border-slate-200 space-y-1">
              <span className="font-black text-amber-600 text-lg">2. No Manipules Cables</span>
              <p className="text-slate-600 text-xs">Evita tocar mecanismos descubiertos o húmedos para prevenir cualquier calambre.</p>
            </div>
            <div className="bg-white p-4 rounded-xl shadow-sm border border-slate-200 space-y-1">
              <span className="font-black text-amber-600 text-lg">3. Desconecta Receptores</span>
              <p className="text-slate-600 text-xs">Desenchufa aparatos de gran consumo para aislar el circuito averiado.</p>
            </div>
          </div>
        </section>
        ...
        <section className="my-16 bg-white rounded-3xl p-8 sm:p-12 border border-slate-200 shadow-sm space-y-8">
          <div className="text-center max-w-3xl mx-auto space-y-2">
            ...
            <h2 className="text-3xl font-black text-slate-900 tracking-tight">Por qué elegir a nuestros instaladores autorizados en Cornellà</h2>
            <p className="text-slate-600 text-sm">Rigor normativo, rapidez y presupuesto cerrado sin costes ocultos.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="p-6 rounded-2xl bg-slate-50 border border-slate-200 space-y-3">
              ...
              <p className="text-slate-600 text-xs leading-relaxed">
                Técnicos homologados para emitir boletines oficiales CIE y aumentos de potencia.
              </p>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-slate-50 border border-slate-200 space-y-3">
              ...
              <p className="text-slate-600 text-xs leading-relaxed">
                Coordinación directa en Centre, Almeda, Sant Ildefons y La Gavarra.
              </p>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-slate-50 border border-slate-200 space-y-3">
              ...
              <p className="text-slate-600 text-xs leading-relaxed">
                Valoración transparente desglosada antes de comenzar la intervención.
              </p>
            </div>
        ...
        <section className="my-16 space-y-8">
          <div className="text-center max-w-3xl mx-auto space-y-2">
            ...
            <h2 className="text-3xl font-black text-slate-900 tracking-tight">Servicios de electricista en Cornellà de Llobregat</h2>
            <p className="text-slate-600 text-sm">Ofrecemos servicio a particulares, naves del Polígono Almeda y comunidades en Cornellà.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 flex flex-col justify-between hover:shadow-md transition-shadow">
              <div className="space-y-3">
                ...
                <p className="text-slate-600 text-xs leading-relaxed">
                  Montajes de baja tensión para pisos, naves y locales en Cornellà conforme al REBT.
                </p>
              </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 flex flex-col justify-between hover:shadow-md border-amber-400 ring-2 ring-amber-400/20 transition-shadow">
              <div className="space-y-3">
                ...
                <h3 className="text-xl font-bold text-slate-900">Boletín Eléctrico (CIE) Cornellà</h3>
                <p className="text-slate-600 text-xs leading-relaxed">
                  Certificado de Instalación Eléctrica oficial para dar de alta la luz o subir potencia contratada.
                </p>
              </div>
              <div className="pt-4 mt-4 border-t border-slate-100">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 flex flex-col justify-between hover:shadow-md transition-shadow">
              <div className="space-y-3">
                ...
                <p className="text-slate-600 text-xs leading-relaxed">
                  Renovación completa del cableado caducado en pisos y locales antiguos de Cornellà.
                </p>
              </div>
              <div className="pt-4 mt-4 border-t border-slate-100">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 flex flex-col justify-between hover:shadow-md transition-shadow">
              <div className="space-y-3">
                ...
                <p className="text-slate-600 text-xs leading-relaxed">
                  Instalación de mecanismos, líneas de gran potencia y luminarias LED.
                </p>
              </div>
              <div className="pt-4 mt-4 border-t border-slate-100">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 flex flex-col justify-between hover:shadow-md transition-shadow">
              <div className="space-y-3">
                ...
                <p className="text-slate-600 text-xs leading-relaxed">
                  Mantenimiento para comunidades de vecinos, videoporteros e industria en Cornellà.
                </p>
              </div>
        ...
        {/* SECTION 5: COBERTURA BARRIOS CORNELLA */}
        <section className="my-16 bg-slate-900 text-white rounded-3xl p-8 sm:p-12 shadow-xl">
          <div className="max-w-3xl space-y-4">
            <span className="text-amber-400 font-extrabold text-xs uppercase tracking-widest">Cobertura en todo Cornellà</span>
            <h2 className="text-3xl font-black tracking-tight text-white">
              Barrios y polígonos de Cornellà atendidos por nuestra red
            </h2>
            <p className="text-slate-300 text-sm leading-relaxed">
              Atención inmediata en menos de 60 minutos en todos los sectores residenciales e industriales.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-8 pt-8 border-t border-slate-800 text-xs font-semibold">
            <div className="p-3 bg-slate-800/60 rounded-lg border border-slate-700/50">
              <span className="text-amber-400 font-bold block mb-0.5">Zona Centro</span>
              <span className="text-slate-400">Centre, Riera, Fontsanta, Fatjó.</span>
            </div>
            <div className="p-3 bg-slate-800/60 rounded-lg border border-slate-700/50">
              <span className="text-amber-400 font-bold block mb-0.5">Zona Almeda</span>
              <span className="text-slate-400">Almeda, El Pedró, Can Mercader.</span>
            </div>
            <div className="p-3 bg-slate-800/60 rounded-lg border border-slate-700/50">
              <span className="text-amber-400 font-bold block mb-0.5">Zona Alta</span>
              <span className="text-slate-400">Sant Ildefons, La Gavarra.</span>
            </div>
            <div className="p-3 bg-slate-800/60 rounded-lg border border-slate-700/50">
              <span className="text-amber-400 font-bold block mb-0.5">Polígonos Industriales</span>
              <span className="text-slate-400">Polígono Almeda, Femades, Famadas.</span>
            </div>
          </div>
        </section>
        ...
        <section className="my-16">
          <ContactForm
            poblacion="Cornellà de Llobregat"
            paginaOrigen="Landing Cornellà - Cierre"
            title="Pide Presupuesto para tu Instalación en Cornellà"
